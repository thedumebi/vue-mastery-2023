        ...
        <div class="card-body">
          <form @submit.prevent="submit">
            ...
            <div class="mb-2">
              ...
              <!-- by default the prop name would be 'modelValue'. if you want to change it
              you can by passing in a modifier e.g. v-model:email. The prop in the component would then be 'email' -->
